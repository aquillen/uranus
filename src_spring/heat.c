...
// apply tidal heat to nodes, raising their temperature
void heat_nodes(struct reb_simulation* const r, int npert, struct node *nodevec,
double dt)
{
   for(int k=0;k<NS;k++){
...
void adjust_spring_temp(struct reb_simulation* r, struct node *nodevec, 
      struct spring mush, 
